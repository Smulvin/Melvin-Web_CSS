...
### Weekverslag 3
Deze week heb ik aan verschillende dingen gewerkt. Zo ben ik begonnen met het verder werken met if(). Hier had ik vorige week vrijdag een begin mee gemaakt en deze week mee verder gegaan voor de benen en het hoofd. Ik vind het een handige manier om op een simpele manier conditionals te schrijven in CSS in plaats van Javascript. Ik moet alleen nog even wennen aan de opbouw. Voor de rest ben ik veel bezig geweest met de functionaliteit van de armen van de octopus. Ik kwam met het idee om radio buttons op het scherm te plaatsen zodat als de speler ergens op klikt dat een arm er dan naartoe zou gaan. Sanne had een paar linkjes gedeeld van een artikel en verschillende codepens. Ik heb deze bestudeerd en veel mee geprobeert, maar het duurde vrij lang om de anchoring goed te laten werken voor elke radio button, en nog langer om dan de maten eruit te krijgen door middel van scroll driven animations. Later bleek het een enkele regel code te zijn geweest die ik had gemist. Ik ben wel verder gekomen met de armen sindsdien. Ik had donderdag avond thuis de juiste selectors om de armen te laten draaien weten te vinden en wist de hypotenuse al weten te berekenen op school. Het is nog niet gelukt om die dingen te combineren. Daar zal ik vrijdag waarschijnlijk nog wel verder naar kijken.
